...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
  ...
  neogen = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/neogen",
  ...
  ["nvim-base16"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/nvim-base16",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-bbye",
  ...
  ["vim-python-pep8-indent"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-python-pep8-indent",
